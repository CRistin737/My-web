...
export const siteData = {
    ...
    hosting: {
        heading: "Hosting & Mantenimiento",
        subheading: "Tu página siempre rápida, segura y funcionando. Servidores propios, sin depender de terceros.",
        items: [
            {
                name: "Starter",
                price: "RD$1,500",
                priceEnd: "/mes",
                desc: "Para páginas web básicas y landing pages que necesitan estar online sin complicaciones.",
                features: [
                    "1 sitio web",
            ...
            },
            {
                ...
                price: "RD$3,500",
                priceEnd: "/mes",
                desc: "Para negocios con más tráfico que necesitan velocidad, seguridad y actualizaciones constantes.",
                features: [
                    "Hasta 5 sitios web",
                    "SSL + CDN global (Cloudflare)",
            ...
            },
            {
                ...
                price: "RD$7,000",
                priceEnd: "/mes",
                desc: "Para aplicaciones web, e-commerce y sistemas que requieren alto rendimiento y escalabilidad.",
                features: [
                    "Sitios y apps ilimitados",
                    "SSL + CDN + WAF (Firewall)",
                    "50 GB almacenamiento SSD NVMe",
                    "Backups diarios + retención 30 días",
                    "Docker containers personalizados",
            ...
            },
            {
                ...
                desc: "Infraestructura dedicada para empresas con necesidades específicas de rendimiento y seguridad.",
                features: [
                    "Servidor dedicado exclusivo",
                    "CPU/RAM/SSD a medida",
                    "VPN privada + IP dedicada",
